...
export const SAMPLE_GOOGLE_CALENDAR_EVENTS: CalendarEvent[] = [
  {
    ...
    endTime: '10:30 AM',
    date: getTodayIso(),
    timestamp: new Date(`${getTodayIso()}T09:30:00`).getTime(),
    category: 'Work',
  ...
  },
  {
    ...
    endTime: '01:00 PM',
    date: getTodayIso(),
    timestamp: new Date(`${getTodayIso()}T11:00:00`).getTime(),
    category: 'Focus',
  ...
  },
  {
    ...
    endTime: '03:15 PM',
    date: getTodayIso(),
    timestamp: new Date(`${getTodayIso()}T14:30:00`).getTime(),
    category: 'Design',
  ...
  },
  {
    ...
    endTime: '06:30 PM',
    date: getTodayIso(),
    timestamp: new Date(`${getTodayIso()}T17:30:00`).getTime(),
    category: 'Personal',
    description: 'Cardio & strength training recovery block.',
    source: 'google',
  },
];
